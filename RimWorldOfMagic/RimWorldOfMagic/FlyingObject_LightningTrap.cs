        ...
        protected void Impact()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                for (int k = 0; k < Rand.Range(1, 8); k++)
                {
                    ...
                    cellRect.ClipInsideMap(Map);
                    IntVec3 randomCell = cellRect.RandomCell;
                    GenExplosion.DoExplosion(randomCell, Map, Rand.Range(.2f, .6f), TMDamageDefOf.DamageDefOf.TM_Lightning, launcher, Mathf.RoundToInt(Rand.Range(2, 6)), 0, SoundDefOf.Thunder_OffMap, null, null, null, null, 0f, 1, null, null, 0, false, null, 0f, 1, 0.1f, true);
                }
            }
            GenExplosion.DoExplosion(origin.ToIntVec3(), base.Map, 1f, TMDamageDefOf.DamageDefOf.TM_Lightning, launcher, Mathf.RoundToInt(Rand.Range(4, 8)), 0, SoundDefOf.Thunder_OffMap, null, null, null, null, 0f, 1, null, null, 0, false, null, 0f, 1, 0.1f, true);
