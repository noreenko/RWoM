...
{
    public class Verb_BrandFitness : VFECore.Abilities.Verb_CastAbility
    {
        bool validTarg;
        ...
        protected override bool TryCastShot()
        {
            ...
            if(casterPawn != null && CurrentTarget.HasThing && CurrentTarget.Thing is Pawn)
            {
                ...
                {
                    TM_Action.UpdateBrand(hitPawn, casterPawn, casterComp, TorannMagicDefOf.TM_FitnessBrandHD);
